...
char* makeStringSendable(char* buffer) {
...
int main(int argc, char* argv[])
{
    ...
    socklen_t clientLen;
    char* buffer;              // buffer for reading from server
   ...
   while(!finished)
   {
       ...
       buffer = makeStringSendable(buffer);      

       nwrite = send(serverSock, buffer, strlen(buffer),0);
